...
const Header = () => {
  ...
  return (
    <header className="fixed top-0 left-0 w-full z-50 bg-gradient-to-r from-purple-600 to-pink-600 shadow-lg font-light">
    <div className="border-b border-gray-400 container mx-auto px-4 md:px-16 pt-2 pb-0 min-w-full bg-gradient-to-r from-gray-900 via-gray-800 to-gray-700 backdrop-blur-lg">
      <div className="flex items-center justify-between">
        <nav className="flex gap-4 md:gap-16 items-center">
          ...
          <div className="hidden lg:flex flex-row relative group space-x-8 items-center">
            <a
              href="/articles"
              className={`${
                activeTab === 1 ? "text-yellow-300" : "text-white"
              } hover:text-yellow-200 transition-colors duration-300 font-semibold tracking-wide`}
            >
              ARTICLES
            </a>
            <a
            ...
            <a className="bg-yellow-500 text-white px-4 py-1 rounded-full hover:bg-yellow-400 transition duration-300 font-semibold shadow-lg transform hover:scale-105">
              LIMITED OFFERS
            </a>
          </div>
        </nav>
      ...
      <div className="flex items-center justify-between w-full">
        ...
        <div className="relative">
          <input
            type="text"
            placeholder="Search..."
            className="px-10 py-2 text-white bg-gray-800 border border-gray-600 focus:outline-none focus:ring-2 focus:ring-yellow-500 w-full max-w-xs rounded transition duration-300"
          />
          <Search
            size={20}
